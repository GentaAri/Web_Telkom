...
<div class="mb-4">
    ...
    <h1 class="mt-4">Tambah E-Surat SPBU</h1>
    </div>
    </div>
    	<div class="col-md-auto">
	<form action="proses_surat.php?act=tambahSurat" method="POST" enctype="multipart/form-data">
      ...
      <div class="form_group">
      	...
      	<input id="id_spbu" name="id_spbu" class="form-control" required>
      ...
      <div class="form_group">
      	...
      	<input id="kota" name="kota" class="form-control" required>
