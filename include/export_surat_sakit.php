...
$excel->getProperties()->setCreator('TelkomAksess')
					   ...
					   ->setTitle("Data Report Surat Sakit")
					   ->setSubject("Report Surat Sakit")
					   ->setDescription("Laporan Semua Data Report Surat Sakit")
					   ->setKeywords("Data Report Surat Sakit");
...
$excel->setActiveSheetIndex(0)->setCellValue('A1', "Data Report Surat Sakit"); // Set kolom A1 dengan tulisan "DATA SISWA"
...
$excel->setActiveSheetIndex(0)->setCellValue('M3', "KETERANGAN SURAT SAKIT");
$excel->setActiveSheetIndex(0)->setCellValue('N3', "TANGGAL SEKTOR SURAT SAKIT");
...
$sql = $pdo->prepare("SELECT * FROM tb_surat_sakit");
...
while($data = $sql->fetch()){ // Ambil semua data dari hasil eksekusi $sql
	$date1=$data['waktu'];
    $date2=$data['tanggal_sektor_surat_sakit'];  
	$tgl1 = strftime("%A, %d %B %Y", strtotime($date1));
	$tgl2 = strftime("%A, %d %B %Y", strtotime($date2));
	...
	$excel->setActiveSheetIndex(0)->setCellValue('L'.$numrow, $tgl1);
	$excel->setActiveSheetIndex(0)->setCellValue('M'.$numrow, $data['keterangan_surat_sakit']);
	$excel->setActiveSheetIndex(0)->setCellValue('N'.$numrow, $tgl2);
...
$excel->getActiveSheet(0)->setTitle("Data Report Surat Sakit");
$excel->setActiveSheetIndex(0);

// Proses file excel
header('Content-Type: application/vnd.openxmlformats-officedocument.spreadsheetml.sheet');
header('Content-Disposition: attachment; filename="Data Report Surat Sakit.xlsx"'); // Set nama file excel nya
